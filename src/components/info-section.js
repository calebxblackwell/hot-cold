...
export default function InfoSection(props) {
  return (
    <section id="what" tabIndex="-1">
      ...
      <ol>
        <li>I pick a <strong>random number</strong> between 1 to 100 and keep it in my brain.</li>
        <li>You need to <strong>guess</strong> until you can figure out the number.</li>
